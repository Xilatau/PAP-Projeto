    ...
    <div class="form">
        ...
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"> 
            <div class="form-group">
                ...
                <span class="invalid-feedback"><br><?php echo $new_password_err; ?></span>
            </div>
            <div class="form-group">
                ...
                <span class="invalid-feedback"><br><?php echo $confirm_password_err; ?></span>
            </div>
            <div class="form-group">
                <input type="submit" class="btn btn-primary" value="Submit"><br>
                <a type="submit" class="btn btn-link ml-2" href="home.php">Cancel</a>
